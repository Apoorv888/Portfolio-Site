  ...
  const skillCategories = [
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'AWS Glue', icon: SiAmazon, level: 85 },
    ...
    },
    {
      ...
      skills: [
        ...
        { name: 'Redshift', icon: SiAmazon, level: 85 },
      ],
    },
    {
      ...
      skills: [
        { name: 'AWS S3', icon: SiAmazon, level: 95 },
        { name: 'AWS EC2', icon: SiAmazon, level: 85 },
        { name: 'AWS MSK', icon: SiAmazon, level: 90 },
        { name: 'Auto Scaling', icon: SiAmazon, level: 80 },
      ],
    },
    {
